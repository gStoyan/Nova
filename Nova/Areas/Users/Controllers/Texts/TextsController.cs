...
namespace Nova.Web.Areas.Users.Controllers.Texts
{
    ...
    public class TextsController : ControllerBase
    {
        ...
        public TextsController(NovaDbContext context,ITextServices textServices)
        {
        ...
        [HttpGet("Nova/{novaId}")]
        public async Task<ActionResult<Text>> GetNovaLastText(int novaId)
        {
            var textModel = await this.textServices.GetNovaLastTextAsync(novaId);
